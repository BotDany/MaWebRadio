#!/usr/bin/env python3
"""
Script pour migrer les radios de l'ancien PostgreSQL vers le nouveau projet Railway
"""
...
# Nouvelle configuration (destination) - Nouveau projet via DATABASE_URL
...
if __name__ == "__main__":
    print("🚀 Migration PostgreSQL : Ancien projet → Nouveau projet")
    print("=" * 60)
    print("📍 Source : trolley.proxy.rlwy.net:27920")
    print("📍 Destination : postgres.railway.internal:5432")
    print("=" * 60)
