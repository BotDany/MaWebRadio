#!/usr/bin/env python3
"""
Script pour initialiser PostgreSQL avec les variables Railway
"""
...
def init_postgresql():
    ...
    try:
        ...
        print(f"✅ Base de données PostgreSQL Railway initialisée avec {count} radios")
...
if __name__ == "__main__":
    print("🚀 Initialisation PostgreSQL Railway pour Ma Webradio")
    print("=" * 60)
