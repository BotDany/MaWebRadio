#!/usr/bin/env python3
"""
Script pour mettre à jour PostgreSQL Railway avec les radios
"""
...
def update_postgresql():
    """Mettre à jour PostgreSQL avec les radios"""
    try:
        ...
        # Liste des radios à insérer/mettre à jour
        radios = [
        ...
        # Mettre à jour ou insérer les radios
        print(f"📻 Mise à jour de {len(radios)} radios...")
        for name, url in radios:
            # Utiliser UPSERT (ON CONFLICT UPDATE)
            cursor.execute("""
        ...
        print(f"✅ Base de données PostgreSQL Railway mise à jour avec {count} radios")
        ...
        print(f"❌ Erreur mise à jour PostgreSQL: {e}")
        return False

if __name__ == "__main__":
    print("🚀 Mise à jour PostgreSQL Railway pour Ma Webradio")
    print("=" * 60)
    success = update_postgresql()
