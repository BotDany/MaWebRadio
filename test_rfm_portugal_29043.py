...
def test_rfm_portugal_29043():
    """Teste RFM Portugal avec l'URL 29043"""
    fetcher = RadioFetcher()
    
    print("Test RFM Portugal avec URL 29043")
    print("===============================")
    ...
    try:
        ...
        if "RADIOSHOW" in metadata.artist or "HANGOUT" in metadata.artist or "BONITO" in metadata.artist:
